...
public class TestURL {
	public static void main(String[] args) throws Exception {
		//1.创建一个URL的对象
//		URL url = new URL("https://185.199.111.153:443");//File file = new File("文件的路径");
		URL url = new URL("https://moistlin.cn");//File file = new File("文件的路径");
...
//		System.out.println(url.getQuery());
		...
		FileOutputStream fos = new FileOutputStream(new File("abc.txt"));//把数据读取到abc.txt 中
		byte[] b1 = new byte[20];
		int len1;
